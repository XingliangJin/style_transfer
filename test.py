...
def parse_args():
    ...
    parser.add_argument('--style_src', type=str, default="data/xia_test/old_01_000.bvh")
    parser.add_argument('--output_dir', type=str, default="demo_results/neutral_01_000@old_01_000")
